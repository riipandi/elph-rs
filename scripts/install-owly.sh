...
#
# Options:
#   --version <tag>      Pin a specific version (default: latest owly-v* release)
#   --canary             Use the latest owly pre-release
#   --install-dir <dir>  Binary install directory (default: ~/.local/bin)
#   --dry-run            Print what would happen without downloading
#   --help               Show this help
#
# Also via env vars: OWLY_VERSION, OWLY_CANARY, OWLY_INSTALL_DIR
set -euo pipefail

INSTALL_APP="owly"
INSTALL_APP_TITLE="owly"
INSTALL_ENV_PREFIX="OWLY"
