...
#
# Options:
#   --version <tag>      Pin a specific version (default: latest eclaw-v* release)
#   --canary             Use the latest eclaw pre-release
#   --install-dir <dir>  Binary install directory (default: ~/.local/bin)
#   --dry-run            Print what would happen without downloading
#   --help               Show this help
#
# Also via env vars: ECLAW_VERSION, ECLAW_CANARY, ECLAW_INSTALL_DIR
set -euo pipefail

INSTALL_APP="eclaw"
INSTALL_APP_TITLE="eclaw"
INSTALL_ENV_PREFIX="ECLAW"
